        ...
        EventChannel(binaryMessenger, EVENT_CHANNEL_NAME).setStreamHandler(
            object : EventChannel.StreamHandler {
                ...
                override fun onListen(arguments: Any?, sink: EventChannel.EventSink?) {
                    ...
                    fun emitIfChanged(payload: Map<String, Any>) {
                    ...
                    emitIfChanged(cm.currentConnectivityMap())
                    ...
                    val callback = object : ConnectivityManager.NetworkCallback() {
                        override fun onAvailable(network: Network) {
                            ...
                            emitIfChanged(mapOf("connected" to true, "type" to type))
                        }

                        override fun onLost(network: Network) {
                            Log.d(tag, "Network lost")
                            emitIfChanged(mapOf("connected" to false, "type" to "none"))
                        }
